    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**")
                        .allowedOrigins("https://todo-front-5txlxnlx1-mahendra-chourasiyas-projects.vercel.app","https://todo-back-production-eb45.up.railway.app") // Adjust this to your frontend URL
